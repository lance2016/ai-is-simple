...
- 当前已确认的章节主图：`assets/chapter-00-chat-completion.png`、`assets/chapter-01-agent-loop.png`、`assets/chapter-02-tool-use.png`、`assets/chapter-03-permission.png`、`assets/chapter-04-hooks.png`。

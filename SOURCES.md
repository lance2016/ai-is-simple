...
- [s07: Skill Loading](https://github.com/shareAI-lab/learn-claude-code/tree/main/s07_skill_loading)
...
本项目与原作者及原项目没有隶属或官方合作关系。

代码示例默认使用 DeepSeek 的 OpenAI 兼容 API 和 OpenAI Python SDK。

  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        text: '实战',
        items: [
          { text: 'Lab 01 · 从零做一个能改代码的 Agent', link: '/labs/01-mini-coding-agent/' },
          { text: 'Lab 02 · 让 Agent 记住项目里的约定', link: '/labs/02-memory/' },
          { text: 'Lab 03 · 把项目调查交给子 Agent', link: '/labs/03-subagent/' },
          { text: 'Lab 04 · 接入 MCP，让 Agent 读写笔记', link: '/labs/04-mcp/' },
          { text: 'Lab 05 · 让 Agent 按测试结果继续修代码', link: '/labs/05-verify/' },
          { text: 'Lab 06 · 给 Agent 加运行记录，方便排查问题', link: '/labs/06-observability/' },
          { text: 'Lab 07 · 对话太长时，压缩旧内容并保留当前任务', link: '/labs/07-context-management/' },
          { text: 'Lab 08 · 用固定任务比较 Agent 修改前后的表现', link: '/labs/08-evaluation/' },
        ],
      },
    ],

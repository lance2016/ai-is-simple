  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        text: '实战',
        items: [
          { text: 'Lab 01 · 做一个能改代码的 Agent', link: '/labs/01-mini-coding-agent/' },
          { text: 'Lab 02 · 给 Agent 加项目记忆', link: '/labs/02-memory/' },
          { text: 'Lab 03 · 让子 Agent 查代码并汇总', link: '/labs/03-subagent/' },
          { text: 'Lab 04 · 用 MCP 让 Agent 读写笔记', link: '/labs/04-mcp/' },
          { text: 'Lab 05 · 测试失败后，Agent 接着修代码', link: '/labs/05-verify/' },
          { text: 'Lab 06 · 记录 Agent 的模型和工具调用', link: '/labs/06-observability/' },
          { text: 'Lab 07 · 压缩旧对话，保留当前任务', link: '/labs/07-context-management/' },
          { text: 'Lab 08 · 用同一组任务对比 Agent 版本', link: '/labs/08-evaluation/' },
        ],
      },
    ],

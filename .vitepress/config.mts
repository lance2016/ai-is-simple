  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        text: '实战',
        items: [
          { text: 'Lab 01 · 自己搭一个能读项目、改代码的 Agent', link: '/labs/01-mini-coding-agent/' },
          { text: 'Lab 02 · 让 Agent 记住项目规则', link: '/labs/02-memory/' },
          { text: 'Lab 03 · 让子 Agent 帮忙调查项目', link: '/labs/03-subagent/' },
          { text: 'Lab 04 · 用 MCP 让 Agent 读写笔记', link: '/labs/04-mcp/' },
          { text: 'Lab 05 · 测试没过，让 Agent 接着修代码', link: '/labs/05-verify/' },
          { text: 'Lab 06 · 把 Agent 的每一步记下来，出错时方便排查', link: '/labs/06-observability/' },
          { text: 'Lab 07 · 把旧对话整理成摘要，让 Agent 接着工作', link: '/labs/07-context-management/' },
          { text: 'Lab 08 · 改了 Agent 之后，怎样知道效果有没有变好？', link: '/labs/08-evaluation/' },
        ],
      },
    ],
